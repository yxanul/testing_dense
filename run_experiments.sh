...
# Comparison experiments for Gated Attention vs Baseline

echo "=========================================="
echo "GPT-2 GATED ATTENTION EXPERIMENTS"
echo "=========================================="

# Common arguments for quick testing
COMMON_ARGS="--batch_size 12 --sequence_length 2048 --num_train_steps 10000 --eval_interval 500"
